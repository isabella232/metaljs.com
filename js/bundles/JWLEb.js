var pageComponent =
webpackJsonppageComponent([28,38,39],[
/* 0 */
...
var _metalAjax = __webpack_require__(149);
...
var _metalToggler = __webpack_require__(146);

var _metalToggler2 = _interopRequireDefault(_metalToggler);

var _Sidebar = __webpack_require__(159);
...
var _TutorialTimer = __webpack_require__(160);
...
var _metalUri = __webpack_require__(206);
...
var _Autocomplete = __webpack_require__(184);

var _Autocomplete2 = _interopRequireDefault(_Autocomplete);

var _AutocompleteBase = __webpack_require__(150);
...
function $render(opt_data, opt_ignored, opt_ijData) {
  ...
  ie_open('div', null, null,
    ...
    ie_open('main', null, null,
      ...
      ie_open('div');
        ie_open('div', null, null,
            'class', 'alert alert-inline alert-warning',
            'style', 'margin:0;');
          ie_void('span', null, null,
              'class', 'icon-16-alert');
          ie_open('span', null, null,
              'class', 'alert-body');
            itext('Metal.js is deprecated and only critical patches will be released in the future.  ');
            ie_open('a', null, null,
                'href', 'https://liferay.dev/blogs/-/blogs/the-state-of-frontend-infrastructure',
                'class', 'alert-link');
              itext('See blog for more info.');
            ie_close('a');
          ie_close('span');
        ie_close('div');
      ie_close('div');
...
function $footerButtons(opt_data, opt_ignored, opt_ijData) {
  ie_open('div', null, null,
    ...
    var tutorialObject__soy92 = opt_data.site.index.children.docs.children['tutorials'].children[opt_data.page.parentId];
    if (opt_data.page.weight < tutorialObject__soy92.childIds.length) {
      if (opt_data.page.buttonTitle) {
        var nextPageUrl__soy97 = tutorialObject__soy92.children[tutorialObject__soy92.childIds[opt_data.page.weight]].url;
        ie_open('a', null, null,
            'href', nextPageUrl__soy97,
 ...
 * @suppress {checkTypes}
 */
function __deltemplate_s114_88c0813b(opt_data, opt_ignored, opt_ijData) {
  ie_open('a', null, null,
...
exports.__deltemplate_s114_88c0813b = __deltemplate_s114_88c0813b;
if (goog.DEBUG) {
  __deltemplate_s114_88c0813b.soyTemplateName = 'tutorial.__deltemplate_s114_88c0813b';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('ElectricNavigation.anchor.idom'), 'tutorial', 0, __deltemplate_s114_88c0813b);
...
function $render(opt_data, opt_ignored, opt_ijData) {
  ie_open('nav', null, null,
    ...
    ie_open('ul', null, null,
        'class', 'topbar-list topbar-list-icons');
      ie_open('li', null, null,
          'class', 'topbar-item');
        ie_open('a', null, null,
            'class', 'topbar-icon',
            'target', '_blank',
            'href', 'https://github.com/metal/metal');
          ie_void('span', null, null,
              'class', 'icon-16-github');
        ie_close('a');
      ie_close('li');
...
function $menu(opt_data, opt_ignored, opt_ijData) {
  $templateAlias1({depth: 1, elementClasses: 'topbar-menu', togglerClasses: 'topbar-toggle', linkClasses: 'topbar-link', listClasses: 'topbar-list', listItemClasses: 'topbar-item', section: opt_data.site.index}, null, opt_ijData);
}
exports.menu = $menu;
if (goog.DEBUG) {
...
var _ElectricAPIAutocomplete = __webpack_require__(170);

var _ElectricAPIAutocomplete2 = _interopRequireDefault(_ElectricAPIAutocomplete);

var _ElectricCode = __webpack_require__(171);

var _ElectricCode2 = _interopRequireDefault(_ElectricCode);

var _ElectricNavigation = __webpack_require__(173);

var _ElectricNavigation2 = _interopRequireDefault(_ElectricNavigation);

var _ElectricReadingProgress = __webpack_require__(175);

var _ElectricReadingProgress2 = _interopRequireDefault(_ElectricReadingProgress);

var _ElectricSearch = __webpack_require__(177);

var _ElectricSearch2 = _interopRequireDefault(_ElectricSearch);

var _ElectricSearchAutocomplete = __webpack_require__(179);

var _ElectricSearchAutocomplete2 = _interopRequireDefault(_ElectricSearchAutocomplete);

var _ElectricUpdates = __webpack_require__(181);
 ...
 * @suppress {checkTypes}
 */
function __deltemplate_s141_d34389eb(opt_data, opt_ignored, opt_ijData) {
  ie_open('a', null, null,
      'class', 'sidebar-link ' + (opt_data.page.active ? 'sidebar-link-selected' : ''),
      'href', opt_data.page.url);
...
exports.__deltemplate_s141_d34389eb = __deltemplate_s141_d34389eb;
if (goog.DEBUG) {
  __deltemplate_s141_d34389eb.soyTemplateName = 'Sidebar.__deltemplate_s141_d34389eb';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('ElectricNavigation.anchor.idom'), 'sidebar', 0, __deltemplate_s141_d34389eb);
...
var _metalClipboard = __webpack_require__(186);
...
var _metalTooltip = __webpack_require__(203);
...
var _metalTabs = __webpack_require__(201);
...
var _metalAffix = __webpack_require__(183);
...
var _metalReadingProgress = __webpack_require__(194);
...
var _metalAutocomplete = __webpack_require__(151);
...
var _ElectricCode = __webpack_require__(172);
...
var _ElectricNavigation = __webpack_require__(174);
...
var _ElectricReadingProgress = __webpack_require__(176);
...
var _ElectricSearch = __webpack_require__(178);
...
var _ElectricSearchAutocomplete = __webpack_require__(180);
...
var _ElectricUpdates = __webpack_require__(182);
...
var _metalDebounce = __webpack_require__(187);
...
var _AutocompleteBase2 = __webpack_require__(150);
...
var _AutocompleteSoy = __webpack_require__(185);
...
var _ListSoy = __webpack_require__(190);
...
var _ListItemSoy = __webpack_require__(192);
...
var _ReadingProgress = __webpack_require__(195);
...
var _ReadingProgressTracker = __webpack_require__(196);
...
var _metalScrollspy = __webpack_require__(197);
...
var _MultiMap = __webpack_require__(198);
...
var _TabsSoy = __webpack_require__(202);
...
var _metalKeyboardFocus = __webpack_require__(188);
...
var _TooltipBase2 = __webpack_require__(205);

var _TooltipBase3 = _interopRequireDefault(_TooltipBase2);

var _TooltipSoy = __webpack_require__(204);
...
var _parse = __webpack_require__(207);

var _parse2 = _interopRequireDefault(_parse);

var _metalStructs = __webpack_require__(200);
...
var _parseFromAnchor = __webpack_require__(208);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JWLEb", function() { return JWLEb; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
// This file was automatically generated from portals.soy.
// Please don't edit this file by hand.

/**
 * @fileoverview Templates in namespace JWLEb.
 * @public
 */

goog.module('JWLEb.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param539 = function() {
    ie_open('article', null, null,
      ...
      ie_close('h2');
      ie_open('p');
        itext('Normally when rendering child components, the generated markup is nested exactly where the child component is. Take the following JSX snippet for example.');
      ie_close('p');
      $templateAlias2({code: 'class Child extends JSXComponent {\n    render() {\n        return <div class="child"></div>;\n    }\n}\n\nclass Parent extends JSXComponent {\n    render() {\n        return <div class="parent">\n            <Child />\n        </div>\n    }\n}\n\n// Resulting markup\n<div class="parent"><div class="child"></div></div>', mode: 'jsx'}, null, opt_ijData);
      ie_open('p');
        itext('But what if you need to render the component elsewhere? Occasionally it\'s necessary to render a child component outside the DOM hierarchy of the parent component. This is where Portals come in.');
      ie_close('p');
      $templateAlias2({code: 'class Child extends JSXComponent {\n    render() {\n        return <div class="child"></div>;\n    }\n}\n\nclass Parent extends JSXComponent {\n    render() {\n        return <div class="parent">\n            <Child portalElement={document.getElementById(\'target\')} />\n        </div>\n    }\n}', mode: 'jsx'}, null, opt_ijData);
      ie_open('p');
        itext('Now the markup of ');
        ie_open('code');
          itext('Child');
        ie_close('code');
        itext(' will be rendered to the ');
        ie_open('code');
          itext('#target');
        ie_close('code');
        itext(' element on the page, but will still receive updates from any data being passed from ');
        ie_open('code');
          itext('Parent');
        ie_close('code');
        itext('. It will also be disposed and detached from the page along with it\'s parent.');
      ie_close('p');
      ie_open('p');
        itext('This is especially useful when creating components such as modals, dropdowns, tooltips, or any component that needs to always overlay other pieces of content.');
      ie_close('p');
    ie_close('article');
    ie_open('article', null, null,
        'id', 'config');
      ...
      ie_open('p');
        ...
        ie_open('code');
          itext('portalElement');
        ie_close('code');
        itext(' property can receive three different types of values: DOM elements, string selectors, or a boolean.');
      ie_close('p');
      ie_open('p');
        itext('DOM elements and string selectors will work as expected:');
      ie_close('p');
      $templateAlias2({code: '<Child portalElement="#target" />\n\n// Is the same as\n\n<Child portalElement={document.getElementById(\'target\')} />', mode: 'jsx'}, null, opt_ijData);
      ie_open('p');
        itext('Passing ');
        ie_open('code');
          itext('true');
        ie_close('code');
        itext(' will select the ');
        ie_open('code');
          itext('body');
        ie_close('code');
        itext(' element by default:');
      ie_close('p');
      $templateAlias2({code: '<Child portalElement={true} />\n\n// Is the same as\n\n<Child portalElement={document.body} />', mode: 'jsx'}, null, opt_ijData);
      ie_open('p');
        itext('Passing ');
        ie_open('code');
          itext('false');
        ie_close('code');
        itext(' will disable the Portal and render the component inline as normal.');
      ie_close('p');
    ie_close('article');
    ie_open('article', null, null,
        'id', 'soy_example');
      ...
      ie_close('h2');
      ie_open('p');
        itext('Portals are supported for Soy components as well. The ');
        ie_open('code');
          itext('portalElement');
        ie_close('code');
        itext(' receives the same values as a JSX component. Here is a snippet where a selector is passed.');
      ie_close('p');
      $templateAlias2({code: '&#123;namespace Parent&#125;\n\n/**\n * This renders the component\'s whole content.\n */\n&#123;template .render&#125;\n    <div class="parent">\n        {call Child.render}\n            {param portalElement: "#target" /}\n        {/call}\n    </div>\n&#123;/template&#125;', mode: 'soy'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'limitations');
      ie_open('h2');
      ...
      ie_close('h2');
      ie_open('p');
        itext('There are a couple of known limitations when using Portals.');
      ie_close('p');
      ie_open('h3');
        itext('Parent element');
      ie_close('h3');
      ie_open('p');
        itext('The main limitation of ');
        ie_open('code');
          itext('portalElement');
        ie_close('code');
        itext(' is that it cannot be set to the same element that houses the root level parent component.');
      ie_close('p');
      $templateAlias2({code: 'class Child extends JSXComponent {\n    render() {\n        return <div class="child"></div>;\n    }\n}\n\nclass Parent extends JSXComponent {\n    render() {\n        // Wrong: rendering Child to same element as parent\n        return <div class="parent">\n            <Child portalElement="#target" />\n        </div>\n    }\n}\n\n// Rendering Parent to the #target element\nnew Parent(null, \'#target\');', mode: 'jsx'}, null, opt_ijData);
      ie_open('p');
        itext('With this configuration, Incremental DOM will throw an error when the Parent component attempts to remove the Child component from the page.');
      ie_close('p');
      ie_open('h3');
        itext('Using elements rendered by parent');
      ie_close('h3');
      ie_open('p');
        itext('While it is recommended to not use elements created by Metal components as a ');
        ie_open('code');
          itext('portalElement');
        ie_close('code');
        itext(', it is possible with the right configuration.');
      ie_close('p');
      ie_open('p');
        itext('The limitation is that ');
        ie_open('code');
          itext('portalElement');
        ie_close('code');
        itext(' needs to be passed an element that exists before the component is rendered. This may seem obvious but take the following snippet as an example.');
      ie_close('p');
      ...
      ie_open('p');
        ...
        ie_open('code');
          itext('Child');
        ie_close('code');
        itext(' will not render to the specified ');
        ie_open('code');
          itext('portalElement');
        ie_close('code');
        itext(', as the ');
        ie_open('code');
          itext('#target');
        ie_close('code');
        itext(' element will not exist at the time of rendering due to how Incremental DOM creates elements.');
      ie_close('p');
      ie_open('p');
        itext('The solution is to wrap the ');
        ie_open('code');
          itext('Child');
        ie_close('code');
        itext(' component in a conditional that will only render it after some kind of user interaction, such as a click.');
      ie_close('p');
      $templateAlias2({code: 'class Child extends JSXComponent {\n    render() {\n        return <div class="child"></div>;\n    }\n}\n\nclass Parent extends JSXComponent {\n    render() {\n        return <div class="parent">\n            <button\n                data-onclick={() => {\n                    this.state.clicked = !this.state.clicked;\n                }}\n            >\n                Toggle\n            </button>\n\n            <div id="target"></div>\n\n            {this.state.clicked && <Child portalElement="#target" />}\n        </div>\n    }\n}\n\nParent.STATE = {\n    clicked: {\n        value: false\n    }\n};', mode: 'jsx'}, null, opt_ijData);
      ie_open('p');
        itext('While this should work for the ');
        ie_open('code');
          itext('Child');
        ie_close('code');
        itext(' component\'s first render, you will run into problems once the ');
        ie_open('code');
          itext('Parent');
        ie_close('code');
        itext(' component starts updating. Portals need to be passed an element that is not removed or modified in any way.');
      ie_close('p');
      ie_open('p');
        itext('This can be accomplished by using a third Component that always returns false in it\'s ');
        ie_open('code');
          itext('shouldUpdate');
        ie_close('code');
        itext(' lifecycle method, and using it as the ');
        ie_open('code');
          itext('portalElement');
        ie_close('code');
        itext(' for the ');
      ...
      ie_open('p');
        itext('Now we have a working example where ');
        ie_open('code');
          itext('Child');
        ie_close('code');
        itext(' is successfully rendered to a ');
        ie_open('code');
          itext('portalElement');
        ie_close('code');
        itext(' that was also created by a Metal component.');
      ie_close('p');
    ie_close('article');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param539}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'JWLEb.render';
}
...
class JWLEb extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(JWLEb, templates);
...
var _portalsSoy = __webpack_require__(238);

var _portalsSoy2 = _interopRequireDefault(_portalsSoy);
...
var JWLEb = function (_Component) {
  _inherits(JWLEb, _Component);

  function JWLEb() {
    _classCallCheck(this, JWLEb);

    return _possibleConstructorReturn(this, (JWLEb.__proto__ || Object.getPrototypeOf(JWLEb)).apply(this, arguments));
  }
...
_metalSoy2.default.register(JWLEb, _portalsSoy2.default);

exports.default = JWLEb;
