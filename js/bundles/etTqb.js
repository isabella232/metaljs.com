var pageComponent =
webpackJsonppageComponent([1,38,39],[
/* 0 */
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "etTqb", function() { return etTqb; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace etTqb.
 * @public
 */

goog.module('etTqb.incrementaldom');
 ...
 */
function $render(opt_data, opt_ignored, opt_ijData) {
  var param1193 = function() {
    ie_open('h2');
      var dyn32 = opt_data.page.title;
      if (typeof dyn32 == 'function') dyn32(); else if (dyn32 != null) itext(dyn32);
    ie_close('h2');
    ie_open('p');
      itext('Now you\'re ready to update the state in ');
      ie_open('code');
        itext('TodoApp');
      ie_close('code');
      itext('. In the last step, you added an event listener:');
    ie_close('p');
    ...
    ie_open('p');
      ...
      ie_open('code');
        itext('this.todos');
      ie_close('code');
      itext(' property to a new array of todos triggers a rerender, passing the data to the child components. Your markup should look like this once you\'ve clicked a todo item:');
    ie_close('p');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param1193}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'etTqb.render';
}
...
class etTqb extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(etTqb, templates);
...
var _updatingStateSoy = __webpack_require__(265);
...
var etTqb = function (_Component) {
  _inherits(etTqb, _Component);

  function etTqb() {
    _classCallCheck(this, etTqb);

    return _possibleConstructorReturn(this, (etTqb.__proto__ || Object.getPrototypeOf(etTqb)).apply(this, arguments));
  }
...
_metalSoy2.default.register(etTqb, _updatingStateSoy2.default);

exports.default = etTqb;
