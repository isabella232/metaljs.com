var pageComponent =
webpackJsonppageComponent([7,38,39],[
/* 0 */
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "veviC", function() { return veviC; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace veviC.
 * @public
 */

goog.module('veviC.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param1025 = function() {
    ...
    ie_open('p');
      ...
      itext(' class:');
    ie_close('p');
    $templateAlias2({code: 'class TodoApp extends Component {\n}', mode: 'text/javascript'}, null, opt_ijData);
    ie_open('p');
      itext('Each component registers a Soy template that renders the component\'s HTML. This is done with the ');
      ie_open('code');
        itext('Soy.register');
      ie_close('code');
      itext(' method:');
    ie_close('p');
    $templateAlias2({code: 'import templates from \'./TodoApp.soy.js\';\nimport Component from \'metal-component\';\nimport Soy from \'metal-soy\';\n\nclass TodoApp extends Component {\n}\nSoy.register(TodoApp, templates);', mode: 'text/javascript'}, null, opt_ijData);
    ie_open('p');
      itext('The ');
      ie_open('code');
        itext('TodoApp');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param1025}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'veviC.render';
}
...
class veviC extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(veviC, templates);
...
var _componentsSoy = __webpack_require__(259);
...
var veviC = function (_Component) {
  _inherits(veviC, _Component);

  function veviC() {
    _classCallCheck(this, veviC);

    return _possibleConstructorReturn(this, (veviC.__proto__ || Object.getPrototypeOf(veviC)).apply(this, arguments));
  }
...
_metalSoy2.default.register(veviC, _componentsSoy2.default);

exports.default = veviC;
