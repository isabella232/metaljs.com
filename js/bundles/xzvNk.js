var pageComponent =
webpackJsonppageComponent([4,38,39],[
/* 0 */
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "xzvNk", function() { return xzvNk; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace xzvNk.
 * @public
 */

goog.module('xzvNk.incrementaldom');
 ...
 */
function $render(opt_data, opt_ignored, opt_ijData) {
  var param1118 = function() {
    ie_open('h2');
      var dyn30 = opt_data.page.title;
      if (typeof dyn30 == 'function') dyn30(); else if (dyn30 != null) itext(dyn30);
    ie_close('h2');
    ie_open('p');
      itext('Now you should have a static list of todo items. What now? Remember the end goal is to be able to click the todos to mark them as completed, so let\'s start with adding a click event listener to the list items:');
    ie_close('p');
    $templateAlias2({code: '// TodoItem.js\n\nclass TodoItem extends Component {\n    ...\n\n    handleClick(event) {\n        alert(this.todo.title);\n    }\n}', mode: 'javascript'}, null, opt_ijData);
    $templateAlias2({code: '&#123;namespace TodoItem&#125;\n\n/**\n * This renders the component\'s whole content.\n */\n&#123;template .render&#125;\n    {@param todo: ?}\n\n    {let $elementClasses kind="text"}\n        todo-item\n        {if $todo.done}\n            {sp}todo-item-done\n        {/if}\n    {/let}\n\n    <li\n        class="{$elementClasses}"\n        // Passing the method name from the TodoItem class\n        data-onclick="handleClick"\n    >\n        {$todo.title}\n    </li>\n&#123;/template&#125;', mode: 'soy'}, null, opt_ijData);
    ie_open('p');
      itext('Notice that only the method name is passed to the ');
      ie_open('code');
        itext('data-onclick');
      ie_close('code');
      itext(' property. Metal automatically checks to see if the Component has that method.');
    ie_close('p');
    ie_open('p');
      itext('Now you should see an alert with the title of the clicked todo. Next you must notify ');
      ie_open('code');
        itext('TodoApp');
      ie_close('code');
      itext(' that a todo was marked as completed so that it can update the data. This can be done by emitting a custom event with the info needed to make the change. In this case we\'ll use the index value from STATE:');
    ie_close('p');
    ...
    ie_open('p');
      ...
      ie_open('code');
        itext('TodoApp');
      ie_close('code');
      itext('. You can accomplish this by creating a function reference. This is simply a Soy ');
      ie_open('code');
        itext('param');
      ie_close('code');
      itext(' that refers to the method you want to use as the callback.');
    ie_close('p');
    $templateAlias2({code: '// TodoApp.js\n\nclass TodoApp extends Component {\n    ...\n\n    handleTodoClick(event) {\n        alert(event.index);\n    }\n}', mode: 'text/javascript'}, null, opt_ijData);
    $templateAlias2({code: '&#123;namespace TodoApp&#125;\n\n/**\n * This renders the component\'s whole content.\n */\n&#123;template .render&#125;\n    // Function reference\n    {@param? handleTodoClick: ?}\n    {@param? todos: ?}\n\n    <div class="todo-app">\n        <ul>\n            {foreach $todo in $todos}\n                {call TodoItem.render}\n                    // Adds the listener for the todoClick event\n                    {param events: [\'todoClick\' : $handleTodoClick] /}\n                    {param index: index($todo) /}\n                    {param todo: $todo /}\n                {/call}\n            {/foreach}\n        </ul>\n    </div>\n&#123;/template&#125;', mode: 'soy'}, null, opt_ijData);
    ie_open('p');
      itext('At this point you should have an event handler that fires every time a todo item is clicked. Next you will use this data to update the state in ');
      ie_open('code');
        itext('TodoApp');
      ie_close('code');
      itext('.');
    ie_close('p');
    ie_open('h3');
      itext('Alternative to custom events');
    ie_close('h3');
    ie_open('p');
      itext('Alternatively, you can pass functions from parents to children to achieve similar functionality. To do this, a child must declare a STATE property to house the function from the parent:');
    ie_close('p');
    $templateAlias2({code: 'class Parent extends Component {\n    handleChange(event) {\n        // Logic\n    }\n}\n\nclass Child extends Component {\n    someMethod() {\n        this.onChange({\n            // Payload\n        });\n    }\n}\n\nChild.STATE = {\n    onChange: {\n    }\n}', mode: 'javascript'}, null, opt_ijData);
    $templateAlias2({code: '&#123;namespace Parent}\n    {@param? handleChange: ?}\n\n    {call Child.render}\n        {param onChange: $handleChange /}\n    {/call}\n&#123;/samespace}', mode: 'soy'}, null, opt_ijData);
  ...
  $templateAlias1(soy.$$assignDefaults({content: param1118}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'xzvNk.render';
}
...
class xzvNk extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(xzvNk, templates);
...
var _eventListenersSoy = __webpack_require__(262);
...
var xzvNk = function (_Component) {
  _inherits(xzvNk, _Component);

  function xzvNk() {
    _classCallCheck(this, xzvNk);

    return _possibleConstructorReturn(this, (xzvNk.__proto__ || Object.getPrototypeOf(xzvNk)).apply(this, arguments));
  }
...
_metalSoy2.default.register(xzvNk, _eventListenersSoy2.default);

exports.default = xzvNk;
