var pageComponent =
webpackJsonppageComponent([13,38,39],[
/* 0 */
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DybJJ", function() { return DybJJ; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace DybJJ.
 * @public
 */

goog.module('DybJJ.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param882 = function() {
    ...
    ie_open('p');
      itext('Notice that the ');
      ie_open('code');
        itext('handleClick');
      ie_close('code');
      itext(' method has been bound to ');
      ie_open('code');
        itext('this');
      ie_close('code');
      itext('. This is because you\'ll need to access instance properties inside the function. However, any JavaScript function can be passed as a handler, it doesn\'t have to be a method of the current class.');
    ie_close('p');
    ie_open('p');
      ...
      ie_open('code');
        itext('TodoApp');
      ie_close('code');
      itext(' that a todo was marked as completed so that it can update the data. This can be done by emitting a custom event with the info needed to make the change. In this case we\'ll use the index value from PROPS:');
    ie_close('p');
    ...
    ie_close('h3');
    ie_open('p');
      itext('Alternatively, you can pass functions from parents to children to achieve similar functionality. To do this, a child must declare a PROP to house the function from the parent:');
    ie_close('p');
    $templateAlias2({code: 'class Parent extends JSXComponent {\n    render() {\n        return (\n            <Child onChange={this.handleChange.bind(this)} />\n        );\n    }\n\n    handleChange(event) {\n        // Logic\n    }\n}\n\nclass Child extends JSXComponent {\n    ...\n\n    someMethod() {\n        this.props.onChange({\n            // Payload\n        });\n    }\n}\n\nChild.PROPS = {\n    onChange: {\n    }\n}', mode: 'text/jsx'}, null, opt_ijData);
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'DybJJ.render';
}
...
class DybJJ extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(DybJJ, templates);
...
var _eventListenersSoy = __webpack_require__(253);
...
var DybJJ = function (_Component) {
  _inherits(DybJJ, _Component);

  function DybJJ() {
    _classCallCheck(this, DybJJ);

    return _possibleConstructorReturn(this, (DybJJ.__proto__ || Object.getPrototypeOf(DybJJ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(DybJJ, _eventListenersSoy2.default);

exports.default = DybJJ;
