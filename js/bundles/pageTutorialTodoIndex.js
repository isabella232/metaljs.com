var pageComponent =
webpackJsonppageComponent([19,38,39],[
/* 0 */
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "pageTutorialTodoIndex", function() { return pageTutorialTodoIndex; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace pageTutorialTodoIndex.
 * @public
 */

goog.module('pageTutorialTodoIndex.incrementaldom');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'pageTutorialTodoIndex.render';
}
      ...
      ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('section', null, null,
              ...
              ie_open('h2', null, null,
                ...
                itext('Select the tutorial you would like to begin.');
              ie_close('h2');
            ie_close('section');
          ie_close('div');
        ie_close('div');
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('div', null, null,
                'class', 'row');
              var childIdList251 = opt_data.page.childIds;
              var childIdListLen251 = childIdList251.length;
              for (var childIdIndex251 = 0; childIdIndex251 < childIdListLen251; childIdIndex251++) {
                var childIdData251 = childIdList251[childIdIndex251];
                var topic__soy241 = opt_data.page.children[childIdData251];
                if (! topic__soy241.hidden) {
                  ie_open('div', null, null,
                      'class', 'col-md-8 col-md-offset-0 col-xs-14 col-xs-offset-1');
                    ie_open('a', null, null,
                        'class', 'topic radial-out',
                        'href', topic__soy241.url);
                      ie_open('div', null, null,
                          'class', 'topic-icon');
                        ie_void('span', null, null,
                            'class', 'icon-16-' + topic__soy241.icon);
                      ie_close('div');
                      ie_open('h3', null, null,
                          'class', 'topic-title');
                        var dyn16 = topic__soy241.title;
                        if (typeof dyn16 == 'function') dyn16(); else if (dyn16 != null) itext(dyn16);
                      ie_close('h3');
                    ie_close('a');
                  ie_close('div');
...
if (goog.DEBUG) {
  $topics.soyTemplateName = 'pageTutorialTodoIndex.topics';
}
...
class pageTutorialTodoIndex extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(pageTutorialTodoIndex, templates);
...
var _indexSoy = __webpack_require__(247);
...
var pageTutorialTodoIndex = function (_Component) {
  _inherits(pageTutorialTodoIndex, _Component);

  function pageTutorialTodoIndex() {
    _classCallCheck(this, pageTutorialTodoIndex);

    return _possibleConstructorReturn(this, (pageTutorialTodoIndex.__proto__ || Object.getPrototypeOf(pageTutorialTodoIndex)).apply(this, arguments));
  }

  return pageTutorialTodoIndex;
}(_metalComponent2.default);

;

_metalSoy2.default.register(pageTutorialTodoIndex, _indexSoy2.default);

exports.default = pageTutorialTodoIndex;
