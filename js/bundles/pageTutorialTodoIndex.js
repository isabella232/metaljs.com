      ...
      ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('div', null, null,
                'class', 'row');
              var childIdList742 = opt_data.page.childIds;
              var childIdListLen742 = childIdList742.length;
              for (var childIdIndex742 = 0; childIdIndex742 < childIdListLen742; childIdIndex742++) {
                var childIdData742 = childIdList742[childIdIndex742];
                var topic__soy732 = opt_data.page.children[childIdData742];
                if (! topic__soy732.hidden) {
                  ie_open('div', null, null,
                      'class', 'col-md-8 col-md-offset-0 col-xs-14 col-xs-offset-1');
                    ie_open('a', null, null,
                        'class', 'topic radial-out',
                        'href', topic__soy732.url);
                      ie_open('div', null, null,
                          'class', 'topic-icon');
                        ie_void('span', null, null,
                            'class', 'icon-16-' + topic__soy732.icon);
                      ie_close('div');
                      ie_open('h3', null, null,
                          'class', 'topic-title');
                        var dyn16 = topic__soy732.title;
                        if (typeof dyn16 == 'function') dyn16(); else if (dyn16 != null) itext(dyn16);
                      ie_close('h3');
                    ie_close('a');
                  ie_close('div');
