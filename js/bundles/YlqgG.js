var pageComponent =
webpackJsonppageComponent([2,38,39],[
/* 0 */
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "YlqgG", function() { return YlqgG; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace YlqgG.
 * @public
 */

goog.module('YlqgG.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param1167 = function() {
    ...
    ie_open('p');
      ...
      ie_open('code');
        itext('TodoItem');
      ie_close('code');
      itext(' for consuming the data passed from');
      ie_open('code');
        itext('TodoApp');
      ie_close('code');
      itext(':');
    ...
    ie_open('p');
      itext('This results in the following markup:');
    ie_close('p');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param1167}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'YlqgG.render';
}
...
class YlqgG extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(YlqgG, templates);
...
var _renderingDataSoy = __webpack_require__(264);
...
var YlqgG = function (_Component) {
  _inherits(YlqgG, _Component);

  function YlqgG() {
    _classCallCheck(this, YlqgG);

    return _possibleConstructorReturn(this, (YlqgG.__proto__ || Object.getPrototypeOf(YlqgG)).apply(this, arguments));
  }
...
_metalSoy2.default.register(YlqgG, _renderingDataSoy2.default);

exports.default = YlqgG;
