var pageComponent =
webpackJsonppageComponent([30,38,39],[
/* 0 */
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GvlNf", function() { return GvlNf; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace GvlNf.
 * @public
 */

goog.module('GvlNf.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param451 = function() {
    ie_open('article');
      ie_open('p');
        itext('For a practical tutorial on how to build components using JSX templates, make sure to go through the ');
        ie_open('a', null, null,
            'href', '/docs/tutorials/tutorial-todo-jsx/before-we-start.html');
          itext('Todo App tutorial');
        ie_close('a');
        itext('.');
      ie_close('p');
      ie_open('p');
    ...
    ie_open('article', null, null,
      ...
      ie_close('h2');
      ie_open('p');
        itext('There are a few additional helpers we also provide for JSX.');
      ie_close('p');
      ie_open('h4');
        ie_open('code');
          itext('this.otherProps()');
        ie_close('code');
      ie_close('h4');
      ie_open('p');
        itext('Used for passing non-named props directly through to the child component.');
      ie_close('p');
      $templateAlias2({code: 'import JSXComponent, {Config} from \'metal-jsx\';\n\nclass MyComponent extends JSXComponent {\n    render() {\n        return (\n            <div>\n                <ChildComponent {...this.otherProps()} />\n            </div>\n        )\n    }\n}\n\nMyComponent.PROPS = {\n    foo: Config.string()\n}\n\n// baz will be passed directly to ChildComponent\n<MyComponent foo="bar" baz="qux" />', mode: 'javascript'}, null, opt_ijData);
      ie_open('h4');
        ie_open('code');
          itext('<DangerouslySetHTML />');
        ie_close('code');
      ie_close('h4');
      ie_open('p');
        itext('Component used for rendering a string as HTML.');
      ie_close('p');
      $templateAlias2({code: 'import JSXComponent, {DangerouslySetHTML} from \'metal-jsx\';\n\nclass MyComponent extends JSXComponent {\n    render() {\n        return (\n            <DangerouslySetHTML\n                content="<h1>Hello World</h1>"\n                tag="div"\n            />\n        )\n    }\n}\n\n// renders\n<div>\n    <h1>\n        Hello World\n    </h1>\n</div>', mode: 'javascript'}, null, opt_ijData);
      ie_open('h4');
        ie_open('code');
          itext('<Fragment />');
        ie_close('code');
      ie_close('h4');
      ie_open('p');
        itext('Component used to return an array of elements.');
      ie_close('p');
      $templateAlias2({code: 'import JSXComponent, {Fragment} from \'metal-jsx\';\n\nclass MyComponent extends JSXComponent {\n    render() {\n        return (\n            <form>\n                {[\'foo\', \'bar\', \'baz\'].map(\n                    name => (\n                        <Fragment key={name}>\n                            <label for={name}>Input {name}</label>\n                            <input name={name} />\n                        </Fragment>\n                    )\n                )}\n            </form>\n        )\n    }\n}\n\n// renders\n<form>\n    <label for="foo">Input foo</label>\n    <input name="foo" />\n\n    <label for="bar">Input bar</label>\n    <input name="bar" />\n\n    <label for="baz">Input baz</label>\n    <input name="baz" />\n</form>', mode: 'javascript'}, null, opt_ijData);
    ie_close('article');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'GvlNf.render';
}
...
class GvlNf extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(GvlNf, templates);
...
var _jsxComponentsSoy = __webpack_require__(236);
...
var GvlNf = function (_Component) {
  _inherits(GvlNf, _Component);

  function GvlNf() {
    _classCallCheck(this, GvlNf);

    return _possibleConstructorReturn(this, (GvlNf.__proto__ || Object.getPrototypeOf(GvlNf)).apply(this, arguments));
  }
...
_metalSoy2.default.register(GvlNf, _jsxComponentsSoy2.default);

exports.default = GvlNf;
