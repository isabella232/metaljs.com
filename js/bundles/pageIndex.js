var pageComponent =
webpackJsonppageComponent([0,38,39],[
/* 0 */
...
function $header(opt_data, opt_ignored, opt_ijData) {
  ie_open('header', null, null,
    ...
    ie_open('div', null, null,
      ...
      ie_open('h1', null, null,
          'class', 'header-title');
        var dyn11 = opt_data.site.index.title;
      ...
      ie_open('div', null, null,
        ...
        ie_open('section', null, null,
          ...
          ie_open('p', null, null,
            ...
            itext('Metal.js is not a library of components, but a foundation for creating the components you need.');
            ie_open('br');
            ie_close('br');
            ie_open('br');
            ie_close('br');
        ...
        ie_open('section', null, null,
          ...
          ie_open('p', null, null,
              'class', 'feature-description');
            itext('Used in numerous production environments already, Metal.js is the backbone of many frontend projects.');
            ie_open('br');
            ie_close('br');
            ie_open('br');
            ie_close('br');
            ie_open('a', null, null,
                'href', 'https://www.npmjs.com/browse/depended/metal',
                'target', '_blank');
              itext('Learn More');
            ie_close('a');
          ie_close('p');
    ...
    ie_open('div', null, null,
      ...
      ie_open('section', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('p', null, null,
              'class', 'highlight-description');
            itext('JSX is a preprocessor step that adds XML syntax to JavaScript, it allows you to write your component markup directly in your Metal.js component class. Keeping your logic and view close together.');
            ie_open('p');
              ie_open('a', null, null,
          ...
          ie_open('p', null, null,
              'class', 'highlight-description');
            itext('Soy is an isomorphic templating language that can be rendered in multiple development environments, and allows for advanced progressive ehancement. The template exists in its own file, seperate from your component\'s JavaScript.');
            ie_open('p');
              ie_open('a', null, null,
                  'href', '/docs/guides/soy-components.html');
                itext('Learn More');
              ie_close('a');
            ie_close('p');
          ie_close('p');
