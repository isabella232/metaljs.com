var pageComponent =
webpackJsonppageComponent([5,38,39],[
/* 0 */
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BHFXW", function() { return BHFXW; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace BHFXW.
 * @public
 */

goog.module('BHFXW.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param1082 = function() {
    ...
    ie_open('p');
      ...
      ie_open('a', null, null,
        ...
        itext('Node.js/npm');
      ie_close('a');
      itext('. You\'ll also need the');
      ie_open('a', null, null,
          'href', 'http://www.oracle.com/technetwork/java/javase/downloads/jre8-downloads-2133155.html');
        itext('Java Runtime Environment');
      ie_close('a');
      itext(' (JRE) installed to compile the ');
      ie_open('code');
        itext('.soy');
      ie_close('code');
      itext(' files.');
    ...
    ie_close('h3');
    ie_open('p');
      itext('Start by cloning the boilerplate repository:');
    ie_close('p');
    $templateAlias2({code: 'git clone https://github.com/metal/metal-tutorial-todo.git', mode: 'text/x-sh'}, null, opt_ijData);
    ie_open('p');
      itext('Then navigate to the root of the project in your terminal and install the local npm dependencies:');
    ie_close('p');
    $templateAlias2({code: 'cd metal-tutorial-todo && npm install', mode: 'text/x-sh'}, null, opt_ijData);
    ie_open('p');
      itext('The boilerplate that you\'ll build on is located in the ');
      ie_open('strong');
        itext('src/soy');
      ie_close('strong');
    ...
    ie_close('h3');
    ie_open('p');
      itext('To test drive the boilerplate located in the ');
      ie_open('strong');
        itext('src/soy');
      ie_close('strong');
      itext(' directory, run the build script shown below:');
    ie_close('p');
    $templateAlias2({code: 'npm run build:soy', mode: 'text/x-sh'}, null, opt_ijData);
    ie_open('p');
      itext('This runs babel + webpack to transpile and bundle the JavaScript into something consumable by web browsers.');
    ie_close('p');
    ie_open('p');
      itext('This tutorial uses ES6 syntax; if you\'re unfamiliar with it, check out');
      ie_open('a', null, null,
    ...
    ie_close('p');
    $templateAlias2({code: 'npm run build:soy:final', mode: 'text/x-sh'}, null, opt_ijData);
    ie_open('h3');
      itext('Demo');
    ie_close('h3');
    ie_open('p');
    ...
    ie_close('p');
    ie_open('p');
      itext('If you check the file you\'ll see that the component is already being invoked:');
    ie_close('p');
    $templateAlias2({code: '<script type="text/javascript">\n    new metal.TodoApp();\n<\/script>', mode: 'text/xml'}, null, opt_ijData);
    ie_open('p');
      itext('When you invoke a component this way, it is rendered to the ');
      ie_open('code');
        itext('body');
      ie_close('code');
      itext(' element.');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param1082}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'BHFXW.render';
}
...
class BHFXW extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(BHFXW, templates);
...
var _dependenciesSoy = __webpack_require__(261);
...
var BHFXW = function (_Component) {
  _inherits(BHFXW, _Component);

  function BHFXW() {
    _classCallCheck(this, BHFXW);

    return _possibleConstructorReturn(this, (BHFXW.__proto__ || Object.getPrototypeOf(BHFXW)).apply(this, arguments));
  }
...
_metalSoy2.default.register(BHFXW, _dependenciesSoy2.default);

exports.default = BHFXW;
