var pageComponent =
webpackJsonppageComponent([17,38,39],[
/* 0 */
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "gSjCS", function() { return gSjCS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace gSjCS.
 * @public
 */

goog.module('gSjCS.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param778 = function() {
    ...
    ie_open('p');
      ie_open('strong');
        itext('Note:');
      ie_close('strong');
      itext(' if you\'re interested in using Metal.js with Soy templates, check out the ');
      ie_open('a', null, null,
          'href', '/docs/tutorials/tutorial-todo-soy/before-we-start.html');
        itext('Soy tutorial');
      ie_close('a');
      itext(' instead.');
    ie_close('p');
    ...
    ie_close('p');
    ie_open('p');
      itext('This is different from frameworks like Angular, which provide a two-way data binding solution.');
    ie_close('p');
    ie_open('h3');
      itext('Templating');
    ie_close('h3');
    ...
    ie_close('p');
    ie_open('p');
      itext('When the data being passed to your component changes, your component\'s template rerenders just the parts of your component that need to be updated. Therefore, you don\'t need to worry about manual DOM manipulation.');
    ie_close('p');
    ie_open('p');
    ...
    ie_open('p');
      ...
      ie_open('a', null, null,
          'href', 'https://github.com/metal/metal-tutorial-todo');
        itext('metal-tutorial-todo');
      ie_close('a');
      itext(' repository.');
    ie_close('p');
    ie_open('p');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param778}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'gSjCS.render';
}
...
class gSjCS extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(gSjCS, templates);
...
var _beforeWeStartSoy = __webpack_require__(249);
...
var gSjCS = function (_Component) {
  _inherits(gSjCS, _Component);

  function gSjCS() {
    _classCallCheck(this, gSjCS);

    return _possibleConstructorReturn(this, (gSjCS.__proto__ || Object.getPrototypeOf(gSjCS)).apply(this, arguments));
  }
...
_metalSoy2.default.register(gSjCS, _beforeWeStartSoy2.default);

exports.default = gSjCS;
