var pageComponent =
webpackJsonppageComponent([36,38,39],[
/* 0 */
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fOaFT", function() { return fOaFT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace fOaFT.
 * @public
 */

goog.module('fOaFT.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param275 = function() {
    ...
    ie_open('article', null, null,
      ...
      ie_open('h2');
        ie_open('a', null, null,
            'href', '#metal-tools-soy');
          itext('metal-tools-soy');
        ie_close('a');
      ie_close('h2');
      ie_open('p');
        itext('This tool is required when building Metal.js components that use Soy. It takes the ');
        ie_open('code');
          itext('.soy');
        ie_close('code');
        itext(' files in your project and transpiles them to JavaScript that can then be imported in your component js files.');
      ie_close('p');
      ie_open('p');
        itext('It\'s suggested to run this tool as a CLI, but it can also be run programmatically if necessary.');
      ie_close('p');
      ie_open('p');
        itext('Take a look at the project\'s ');
        ie_open('a', null, null,
            'href', 'https://www.npmjs.com/package/metal-tools-soy');
          itext('documentation');
        ie_close('a');
        itext(' for more information.');
      ie_close('p');
      ie_open('p');
        itext('If you are using webpack to bundle your Metal.js components, you can optionally use the ');
        ie_open('a', null, null,
            'href', 'https://www.npmjs.com/package/metal-soy-loader');
          itext('metal-soy-loader');
        ie_close('a');
        itext(' which conveniently wraps metal-tools-soy for use with webpack.');
      ie_close('p');
    ie_close('article');
    ie_open('article', null, null,
        'id', 'babel-preset-metal-jsx');
      ie_open('h2');
        ie_open('a', null, null,
            'href', '#babel-preset-metal-jsx');
          itext('babel-preset-metal-jsx');
        ie_close('a');
      ie_close('h2');
      ie_open('p');
        itext('When building Metal.js JSX components, it is necessary to transpile the JSX to JavaScript. The ');
        ie_open('a', null, null,
            'href', 'https://www.npmjs.com/package/babel-preset-metal-jsx');
          itext('babel-preset-metal-jsx');
        ie_close('a');
        itext(' package takes care of importing the necessary babel plugins that allow for this transpilation.');
      ie_close('p');
    ie_close('article');
    ie_open('article', null, null,
        'id', 'examples');
      ...
      ie_close('h2');
      ie_open('p');
        itext('To see examples of these tools in action, check out the ');
        ie_open('a', null, null,
            'href', 'https://www.npmjs.com/package/generator-metal');
          itext('Yeoman Generator');
        ie_close('a');
        itext('. The boilerplate it generates for both Soy and JSX components implement these tools out of the box.');
      ie_close('p');
    ie_close('article');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'fOaFT.render';
}
...
class fOaFT extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(fOaFT, templates);
...
var _buildingSoy = __webpack_require__(230);
...
var fOaFT = function (_Component) {
  _inherits(fOaFT, _Component);

  function fOaFT() {
    _classCallCheck(this, fOaFT);

    return _possibleConstructorReturn(this, (fOaFT.__proto__ || Object.getPrototypeOf(fOaFT)).apply(this, arguments));
  }
...
_metalSoy2.default.register(fOaFT, _buildingSoy2.default);

exports.default = fOaFT;
