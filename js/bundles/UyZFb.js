var pageComponent =
webpackJsonppageComponent([9,38,39],[
/* 0 */
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UyZFb", function() { return UyZFb; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace UyZFb.
 * @public
 */

goog.module('UyZFb.incrementaldom');
  ...
  var param971 = function() {
    ...
    ie_open('p');
      ...
      ie_open('code');
        itext('TodoForm');
      ie_close('code');
      itext(' component comes into play.');
    ie_close('p');
    ie_open('p');
      itext('First, go ahead and add a couple of event listeners: one for the form submission (onsubmit) and one for when the input value changes (onkeyup):');
    ie_close('p');
    $templateAlias2({code: '// TodoForm.js\n\nclass TodoForm extends Component {\n    handleSubmit(event) {\n        // Prevent default browser functionality\n        event.preventDefault();\n    }\n\n    handleChange(event) {\n    }\n}', mode: 'text/javascript'}, null, opt_ijData);
    $templateAlias2({code: '&#123;namespace TodoForm&#125;\n\n/**\n * This renders the component\'s whole content.\n */\n&#123;template .render&#125;\n    <form class="todo-form" data-onsubmit="handleSubmit">\n        <label for="title">\n            Todo <input data-onkeyup="handleChange" name="title" />\n        </label>\n        <button type="submit">Add</button>\n    </form>\n&#123;/template&#125;', mode: 'soy'}, null, opt_ijData);
    ie_open('p');
      itext('Now you can use the ');
      ie_open('code');
        itext('value');
      ie_close('code');
      itext(' property from STATE to keep track of the changes made to the input value. This makes the input a ');
      ie_open('strong');
        itext('controlled input');
      ie_close('strong');
      itext(', where the value of the input is controlled by the state of the component. In other words, when the value of the state changes, it automatically changes the value in the input as well, keeping the two in sync.');
    ie_close('p');
    ...
    ie_open('p');
      itext('Now when you add some text to the input and submit the form, a new todo is automatically added to the list.');
    ie_close('p');
    ie_open('p');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'UyZFb.render';
}
...
class UyZFb extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(UyZFb, templates);
...
var _addingTodosSoy = __webpack_require__(257);
...
var UyZFb = function (_Component) {
  _inherits(UyZFb, _Component);

  function UyZFb() {
    _classCallCheck(this, UyZFb);

    return _possibleConstructorReturn(this, (UyZFb.__proto__ || Object.getPrototypeOf(UyZFb)).apply(this, arguments));
  }
...
_metalSoy2.default.register(UyZFb, _addingTodosSoy2.default);

exports.default = UyZFb;
