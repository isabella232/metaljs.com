var pageComponent =
webpackJsonppageComponent([6,38,39],[
/* 0 */
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "tKjQR", function() { return tKjQR; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace tKjQR.
 * @public
 */

goog.module('tKjQR.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param1046 = function() {
    ...
    ie_close('h2');
    ie_open('p');
      itext('As previously mentioned, Metal components automatically respond to the data passed to them and rerender. For a component to take advantage of this behavior, however, it needs to be told what data to respond to. This is where state comes in.');
    ie_close('p');
    ie_open('p');
    ...
    ie_open('p');
      itext('Now that there is a default value set, you can access the value in the Soy template after defining it as a soy ');
      ie_open('code');
        itext('param');
      ie_close('code');
      itext(':');
    ...
    ie_open('p');
      itext('Which results in the following markup:');
    ie_close('p');
    ...
    ie_open('p');
      ...
      ie_open('code');
        itext('TodoItem');
      ie_close('code');
      itext(' component will need two properties defined in STATE: one for keeping track of it\'s index inside the list and one for containing the todo data itself:');
    ie_close('p');
    $templateAlias2({code: '// TodoItem.js\n\nclass TodoItem extends Component {\n    ...\n}\n\nTodoItem.STATE = {\n    index: {\n        value: null\n    },\n\n    todo: {\n        value: null\n    }\n};', mode: 'text/javascript'}, null, opt_ijData);
    ie_open('p');
      itext('These STATE properties will act as read-only for the ');
      ie_open('code');
        itext('TodoItem');
      ie_close('code');
      itext(' component, as the values will always be defined by the parent component and passed down.');
    ie_close('p');
    ie_open('h3');
      itext('Form');
    ie_close('h3');
    ie_open('p');
      ...
      ie_open('code');
        itext('TodoForm');
      ie_close('code');
      itext(' only needs one property that will eventually be used to keep track of the value of it\'s input:');
    ie_close('p');
    $templateAlias2({code: '// TodoForm.js\n\nclass TodoForm extends Component {\n    ...\n}\n\nTodoForm.STATE = {\n    value: {\n        value: \'\'\n    }\n};', mode: 'text/javascript'}, null, opt_ijData);
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'tKjQR.render';
}
...
class tKjQR extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(tKjQR, templates);
...
var _configuratingStateSoy = __webpack_require__(260);
...
var tKjQR = function (_Component) {
  _inherits(tKjQR, _Component);

  function tKjQR() {
    _classCallCheck(this, tKjQR);

    return _possibleConstructorReturn(this, (tKjQR.__proto__ || Object.getPrototypeOf(tKjQR)).apply(this, arguments));
  }
...
_metalSoy2.default.register(tKjQR, _configuratingStateSoy2.default);

exports.default = tKjQR;
